...
class QueenBlockMovesTests(unittest.TestCase):
    ...
    def testBlockWhiteQueenFromA1ToH8(self):
        ...
        self.testUtility.failToMove(Values.queen, self.testUtility.getMove(A1, H8))

    def testBlockWhiteQueenFromH1ToA8(self):
        self.testUtility = TestUtility(self.board, self.gameLogic.whitePlayer)
        self.testUtility.moveValueToSquare(Values.queen, D5)
        self.testUtility.failToMove(Values.queen, self.testUtility.getMove(H1, A8))
    ...
    def testBlockWhiteQueenFromD4ToE5ToF6(self):
        ...
        self.testUtility.invalidMove( \
            self.testUtility.failToMove(Values.queen, \
    ...
    def testBlockWhiteQueenFromA1ToA8(self):
        ...
        self.testUtility.failToMove(Values.queen, self.testUtility.getMove(A1, A8))

    def testBlockWhiteQueenFromH1ToA1(self):
        self.testUtility = TestUtility(self.board, self.gameLogic.whitePlayer)
        self.testUtility.moveValueToSquare(Values.queen, A1)
        self.testUtility.failToMove(Values.queen, self.testUtility.getMove(H1, A1))
