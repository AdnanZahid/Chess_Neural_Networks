...
class PawnBlockMovesTests(unittest.TestCase):
    ...
    def testBlockWhitePawnFromA2ToA4(self):
        ...
        self.testUtility.failToMoveButValidMoveOnNewBoard(Values.pawn, self.testUtility.getMove(A2, A4))

    def testBlockWhitePawnFromH6ToH7(self):
        self.testUtility = TestUtility(self.board, self.gameLogic.whitePlayer)
        self.testUtility.moveValueToSquare(Values.pawn, H7)
        self.testUtility.failToMoveButValidMoveOnNewBoard(Values.pawn, self.testUtility.getMove(H6, H7))
    ...
    def testBlockWhitePawnFromD2ToD3ToD4(self):
        ...
        self.testUtility.invalidMoveButValidOnNewBoard( \
            self.testUtility.failToMoveButValidMoveOnNewBoard(Values.pawn, \
    ...
    def testBlockBlackPawnFromA7ToA5(self):
        ...
        self.testUtility.failToMoveButValidMoveOnNewBoard(-Values.pawn, self.testUtility.getMove(A7, A5))

    def testBlockBlackPawnFromH5ToH4(self):
        self.testUtility = TestUtility(self.board, self.gameLogic.blackPlayer)
        self.testUtility.moveValueToSquare(-Values.pawn, H4)
        self.testUtility.failToMoveButValidMoveOnNewBoard(-Values.pawn, self.testUtility.getMove(H5, H4))
