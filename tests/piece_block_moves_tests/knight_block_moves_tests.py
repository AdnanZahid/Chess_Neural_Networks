...
class KnightBlockMovesTests(unittest.TestCase):
    ...
    def testBlockWhiteKnightFromA1ToC2(self):
        ...
        self.testUtility.failToMoveButValidMoveOnNewBoard(Values.knight, self.testUtility.getMove(A1, C2))

    def testBlockWhiteKnightFromH1ToG3(self):
        self.testUtility = TestUtility(self.board, self.gameLogic.whitePlayer)
        self.testUtility.moveValueToSquare(Values.knight, G3)
        self.testUtility.failToMoveButValidMoveOnNewBoard(Values.knight, self.testUtility.getMove(H1, G3))
    ...
    def testBlockWhiteKnightFromD6ToE6ToF5(self):
        ...
        self.testUtility.invalidMoveButValidOnNewBoard( \
            self.testUtility.failToMoveButValidMoveOnNewBoard(Values.knight, \
