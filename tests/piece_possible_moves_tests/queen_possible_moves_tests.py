...
class QueenPossibleMovesTests(unittest.TestCase):
    ...
    def testPossibleMovesWhiteQueenFromA1(self):
        ...
        possibleMoves = self.testUtility.generateAllPossibleTargetSquares(self.testUtility.movePieceValueToSquare(Values.queen, A1))
    ...
    def testPossibleMovesWhiteQueenFromD5(self):
        self.board.currentTurnColor = Color.white
        possibleMoves = self.testUtility.generateAllPossibleTargetSquares(self.testUtility.movePieceValueToSquare(Values.queen, D5))
    ...
    def testPossibleMovesWhiteQueenFromD4FriendlyFire(self):
        ...
        possibleMoves = self.testUtility.generateAllPossibleTargetSquares(self.testUtility.movePieceValueToSquare(Values.queen, D4))
        comparisonMoves = []
        self.testUtility.checkEqualMoves(possibleMoves, comparisonMoves)
    ...
    def testPossibleMovesBlackQueenFromH1(self):
        ...
        possibleMoves = self.testUtility.generateAllPossibleTargetSquares(self.testUtility.movePieceValueToSquare(-Values.queen, H1))
        comparisonMoves = [G2, F3, E4, D5, C6, B7, A8, H2, H3, H4, H5, H6, H7, H8, G1, F1, E1, D1, C1, B1, A1]
        self.testUtility.checkEqualMoves(possibleMoves, comparisonMoves)

    def testPossibleMovesBlackQueenFromE4(self):
        self.board.currentTurnColor = Color.black
        possibleMoves = self.testUtility.generateAllPossibleTargetSquares(self.testUtility.movePieceValueToSquare(-Values.queen, E4))
    ...
    def testPossibleMovesBlackQueenFromDE6FriendlyFire(self):
        ...
        possibleMoves = self.testUtility.generateAllPossibleTargetSquares(self.testUtility.movePieceValueToSquare(-Values.queen, E6))
        comparisonMoves = []
        self.testUtility.checkEqualMoves(possibleMoves, comparisonMoves)
