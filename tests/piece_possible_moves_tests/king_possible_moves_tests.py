...
class KingPossibleMovesTests(unittest.TestCase):
    ...
    def testPossibleMovesWhiteKingFromA1(self):
        ...
        possibleMoves = self.testUtility.generateAllPossibleTargetSquares(self.testUtility.movePieceValueToSquare(Values.king, A1))
    ...
    def testPossibleMovesWhiteKingFromD5(self):
        self.board.currentTurnColor = Color.white
        possibleMoves = self.testUtility.generateAllPossibleTargetSquares(self.testUtility.movePieceValueToSquare(Values.king, D5))
    ...
    def testPossibleMovesWhiteKingFromD4FriendlyFire(self):
        ...
        possibleMoves = self.testUtility.generateAllPossibleTargetSquares(self.testUtility.movePieceValueToSquare(Values.king, D4))
        comparisonMoves = []
        self.testUtility.checkEqualMoves(possibleMoves, comparisonMoves)
    ...
    def testPossibleMovesBlackKingFromH1(self):
        ...
        possibleMoves = self.testUtility.generateAllPossibleTargetSquares(self.testUtility.movePieceValueToSquare(-Values.king, H1))
        comparisonMoves = [G2, H2, G1]
        self.testUtility.checkEqualMoves(possibleMoves, comparisonMoves)

    def testPossibleMovesBlackKingFromE4(self):
        self.board.currentTurnColor = Color.black
        possibleMoves = self.testUtility.generateAllPossibleTargetSquares(self.testUtility.movePieceValueToSquare(-Values.king, E4))
    ...
    def testPossibleMovesBlackKingFromDE6FriendlyFire(self):
        ...
        self.testUtility.movePieceValueToSquare(-Values.queen, D5)
        possibleMoves = self.testUtility.generateAllPossibleTargetSquares(self.testUtility.movePieceValueToSquare(-Values.king, E6))
        comparisonMoves = []
        self.testUtility.checkEqualMoves(possibleMoves, comparisonMoves)
