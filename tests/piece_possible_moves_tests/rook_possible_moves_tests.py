...
class RookPossibleMovesTests(unittest.TestCase):
    ...
    def testPossibleMovesWhiteRookFromA1(self):
        ...
        possibleMoves = self.testUtility.generateAllPossibleTargetSquares(self.testUtility.movePieceValueToSquare(Values.rook, A1))
    ...
    def testPossibleMovesWhiteRookFromD5(self):
        self.board.currentTurnColor = Color.white
        possibleMoves = self.testUtility.generateAllPossibleTargetSquares(self.testUtility.movePieceValueToSquare(Values.rook, D5))
    ...
    def testPossibleMovesWhiteRookFromD4FriendlyFire(self):
        ...
        possibleMoves = self.testUtility.generateAllPossibleTargetSquares(self.testUtility.movePieceValueToSquare(Values.rook, D4))
        comparisonMoves = []
        self.testUtility.checkEqualMoves(possibleMoves, comparisonMoves)
    ...
    def testPossibleMovesBlackRookFromH1(self):
        ...
        possibleMoves = self.testUtility.generateAllPossibleTargetSquares(self.testUtility.movePieceValueToSquare(-Values.rook, H1))
        comparisonMoves = [H2, H3, H4, H5, H6, H7, H8, G1, F1, E1, D1, C1, B1, A1]
        self.testUtility.checkEqualMoves(possibleMoves, comparisonMoves)

    def testPossibleMovesBlackRookFromE4(self):
        self.board.currentTurnColor = Color.black
        possibleMoves = self.testUtility.generateAllPossibleTargetSquares(self.testUtility.movePieceValueToSquare(-Values.rook, E4))
    ...
    def testPossibleMovesBlackRookFromDE6FriendlyFire(self):
        ...
        possibleMoves = self.testUtility.generateAllPossibleTargetSquares(self.testUtility.movePieceValueToSquare(-Values.rook, E6))
        comparisonMoves = []
        self.testUtility.checkEqualMoves(possibleMoves, comparisonMoves)
