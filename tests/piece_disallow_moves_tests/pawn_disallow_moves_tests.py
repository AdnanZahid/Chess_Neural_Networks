...
class PawnDisallowMovesTests(unittest.TestCase):
    ...
    def testfailToMoveButValidMoveOnNewBoardWhitePawnFromB2ToA4(self):
        self.testUtility = TestUtility(self.board, self.gameLogic.whitePlayer)
        self.testUtility.failToMove(Values.pawn, self.testUtility.getMove(B2, A4))

    def testfailToMoveButValidMoveOnNewBoardWhitePawnFromA6ToF7(self):
        self.testUtility = TestUtility(self.board, self.gameLogic.whitePlayer)
        self.testUtility.failToMove(Values.pawn, self.testUtility.getMove(A6, F7))

    def testfailToMoveButValidMoveOnNewBoardWhitePawnFromA2ToD3ToD4(self):
        self.testUtility = TestUtility(self.board, self.gameLogic.whitePlayer)
    ...
    def testfailToMoveButValidMoveOnNewBoardBlackPawnFromG7ToA5(self):
        self.testUtility = TestUtility(self.board, self.gameLogic.blackPlayer)
        self.testUtility.failToMove(-Values.pawn, self.testUtility.getMove(G7, A5))

    def testfailToMoveButValidMoveOnNewBoardBlackPawnFromA7ToF6(self):
        self.testUtility = TestUtility(self.board, self.gameLogic.blackPlayer)
        self.testUtility.failToMove(-Values.pawn, self.testUtility.getMove(A7, F6))

    def testfailToMoveButValidMoveOnNewBoardBlackPawnFromA7ToD6ToD5(self):
        self.testUtility = TestUtility(self.board, self.gameLogic.blackPlayer)
