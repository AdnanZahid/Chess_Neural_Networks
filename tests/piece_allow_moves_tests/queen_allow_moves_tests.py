...
class QueenAllowMovesTests(unittest.TestCase):
    ...
    def testMoveWhiteQueenFromD4ToE5ToF4(self):
        self.testUtility.movePieceToSquare(self.testUtility.movePiece(Values.queen, self.testUtility.getMove(D4, E5)),
                                           F4)
    ...
    def testMoveWhiteQueenFromD4ToD5ToF5(self):
        self.testUtility.movePieceToSquare(self.testUtility.movePiece(Values.queen, self.testUtility.getMove(D4, D5)),
                                           F5)
