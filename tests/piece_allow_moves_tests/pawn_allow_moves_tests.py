...
class PawnAllowMovesTests(unittest.TestCase):
    ...
    def testMoveWhitePawnFromD2ToD3ToD4(self):
        self.testUtility.movePieceToSquare(self.testUtility.movePiece(Values.pawn, self.testUtility.getMove(D2, D3)),
                                           D4)
    ...
    def testMoveBlackPawnFromD7ToD6ToD5(self):
        self.testUtility.movePieceToSquare(self.testUtility.movePiece(-Values.pawn, self.testUtility.getMove(D7, D6)),
                                           D5)
